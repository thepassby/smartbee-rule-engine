...
public interface RuleEngineApi {
	...
	@RequestMapping(value = "/rule/send", produces = { MediaType.TEXT_HTML_VALUE }, method = RequestMethod.PUT)
	...
	public ResponseEntity<String> send(
			@NotNull @ApiParam(value = "the message that will be sended.", required = true) @RequestParam(value = "message", required = true) String message) throws NotFoundException;
}
